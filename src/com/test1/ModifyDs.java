...
public class ModifyDs {
	...
	public ModifyDs(Integer actionId, String actionName, boolean amendType, String closeType, long noDraftCount,
			Boolean sellIndicator, String workflowName, String draftName, String creationDate, String modifiedDate,
			String entityState) {
		super();

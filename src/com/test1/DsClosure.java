...
public class DsClosure {
	...
	public DsClosure(Integer crId, String refName, String closeRoute, Boolean onlyMaker, Boolean onlyChecker,
			Boolean deleteOnSucccess, Boolean autoApproval, Integer autoApprovalStep, String creationDate,
		...
		this.deleteOnSucccess = deleteOnSucccess;
	...
	public Boolean getDeleteOnSucccess() {
		return deleteOnSucccess;
	}

	public void setDeleteOnSucccess(Boolean deleteOnSucccess) {
		this.deleteOnSucccess = deleteOnSucccess;
	}
